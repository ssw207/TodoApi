...
public class BoardRepositoryTest {
	...
	public void 게시글_저장_삭제() {
		// when
		Board dto = r.save(Board.builder().title("제목").content("내용").memId("작성자").cnt(1).build());
	...
	public void 게시글_수정() {
		// given
		Board savedDto = r.save(Board.builder().title("제목").content("내용").memId("작성자").cnt(1).build());
		...
		r.delete(modifiedDto);
	}

	@Test
	public void 게시글_목록조회() {
		// given
		Board savedDto1 = r.save(Board.builder().title("제목").content("내용").memId("작성자").cnt(1).build());
		Board savedDto2 = r.save(Board.builder().title("제목").content("내용").memId("작성자").cnt(1).build());
	...
	public void 게시글_eq검색() {
		// given
		for (int i = 1; i < 10; i++) {
			r.save(Board.builder().title("제목" + i).content("내용" + i).memId("작성자").cnt(i).build());
		}
